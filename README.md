...
Graceful Degradation: При отказе чата, записи или базы списка встреч пользователь теряет только эти функции, но видеозвонок продолжается без простоя потому что WebRTC и Signaling изолирован от вспомогательных сервисов
