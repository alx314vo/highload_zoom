...
Асинхронные паттерны для надежности: Event-driven, ретрай с экспоненциальной задержкой (повторяем упавший запрос с растущими интервалами), Circuit Breaker (размыкаем цепь при серии ошибок, чтобы не долбить мертвый сервис)
...
- оценка производительности Go сервисов: ~3,500 RPS на 1 vCPU
